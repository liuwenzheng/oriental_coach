...
public class PreferencesUtil {
    ...
    public static int getIntByName(Context context, String name, int default_value) {
        return PreferenceManager.getDefaultSharedPreferences(context).getInt(name, default_value);
    }

    public static long getLongByName(Context context, String name, long default_value) {
        return PreferenceManager.getDefaultSharedPreferences(context).getLong(name, default_value);
    }

    public static boolean getBooleanByName(Context context, String name, boolean default_value) {
    ...
    public static void setBooleanByName(Context context, String name, Boolean value) {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        Editor editor = sp.edit();
